...
def optimize_patch_finite_diff(sess, img1_yuv, img2_yuv, h_bounds, w_bounds, initial_patch,
    ...
    """
    # initial_patch = np.zeros_like(initial_patch,dtype=np.float32)
    ...
    for it in range(steps):
        ...
        for idx in chosen:
            ...
            # print(f'pplus:{np.where((p_plus-p_minus)!=0)}')

            # print(f'pminus:{p_minus}')
            ...
            # print(f'lossp:{loss_p},lossm:{loss_m}')
