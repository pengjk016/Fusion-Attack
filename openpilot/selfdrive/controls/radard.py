...
class RadarD:
  def __init__(self, radar_ts: float, delay: int = 0):
    ...
    self.zmq_sub_clean = self.zmq_context.socket(zmq.SUB)
    self.zmq_sub_clean.connect("tcp://127.0.0.1:5556")
    self.zmq_sub_clean.setsockopt_string(zmq.SUBSCRIBE, "")
    self.latest_clean_dRel = -1.0
