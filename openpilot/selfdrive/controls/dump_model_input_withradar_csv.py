...
class RadarD:
    ...
    def update(self, sm: messaging.SubMaster, rr: Optional[car.RadarData]):
        ...
        if len(leads_v3) > 1:
            ...
            print(f'radar_state.leadOne: {self.radar_state.leadOne}')
            print(f'radar_state.leadTwo: {self.radar_state.leadTwo}')
...
def main():
    ...
    fieldnames = ['frame_idx', 'image_path', 'dRel', 'yRel', 'vRel', 'vLead', 'vLeadK',
    ...
    for i in range(NUM_FRAMES):
        ...
        print(f"Saved leadOne for frame {frame_idx} → {CSV_FILE}")
        # ===========================================================
